defmodule PhoenixKitEcommerce.Translations do
  @moduledoc """
  ...
  def translatable_fields(%{__struct__: PhoenixKitEcommerce.Product}), do: @product_fields
  def translatable_fields(%{__struct__: PhoenixKitEcommerce.Category}), do: @category_fields
