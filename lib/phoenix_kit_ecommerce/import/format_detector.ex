defmodule PhoenixKitEcommerce.Import.FormatDetector do
  @moduledoc """
  ...
  alias PhoenixKitEcommerce.Import.CSVValidator
  alias PhoenixKitEcommerce.Import.{PromUaFormat, ShopifyFormat}
